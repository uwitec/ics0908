...
InsertBeforeEnd(u2based, "<div class='anncontent'><span class='annfieldname'>Specification:</span> 脚注，版权公司名称和标志<BR><BR></div>");
...
InsertBeforeEnd(u31based, "<div class='anncontent'><span class='annfieldname'>Specification:</span> 系统中文名<BR><BR></div>");
...
InsertBeforeEnd(u8based, "<div class='anncontent'><span class='annfieldname'>Specification:</span> 登录面板，用来切换普通用户登录和管理员登录界面。<BR><BR></div>");
...
InsertBeforeEnd(u32based, "<div class='anncontent'><span class='annfieldname'>Specification:</span> 系统英文名<BR><BR></div>");
...
InsertBeforeEnd(u0based, "<div class='anncontent'><span class='annfieldname'>Specification:</span> 登录页面背景图片<BR><BR></div><div class='anncontent'><span class='annfieldname'>Assigned To:</span> window.document<BR><BR></div>");
...
InsertBeforeEnd(u26based, "<div class='anncontent'><span class='annfieldname'>Specification:</span> 错误信息提示面板<BR><BR></div>");
...
InsertBeforeEnd(u25based, "<div class='anncontent'><span class='annfieldname'>Specification:</span> 软件简介<BR><BR></div>");
...
InsertBeforeEnd(u29based, "<div class='anncontent'><span class='annfieldname'>Specification:</span> 公司LOGO<BR><BR></div>");
...
InsertBeforeEnd(u27based, "<div class='anncontent'><span class='annfieldname'>Specification:</span> 错误信息显示区<BR><BR></div>");
