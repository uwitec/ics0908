	...
	<div class="body_div">
		<div id="seachDIV" class="searche_DIV" style="display: none;height:200px;">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" style='background-color:#E2F3FB;border-left:#0C6A9D 1 solid;border-right:#0C6A9D 1px solid;'>
				...
				<tr style="margin-top: 5px;"><td style="font-size:12px;color:#636B6D;" align="center">
					开始时间:<s:textfield cssClass="sub3_border" onclick="SelectDate(this,'yyyy-MM-dd')" readonly="true" name="materinf.startTime" value="%{materinf.startTime}" cssStyle="margin-top:5px;" /></td></tr>
				<tr style="margin-top: 5px;"><td style="font-size:12px;color:#636B6D;" align="center">
						截至时间:<s:textfield cssClass="sub3_border" onclick="SelectDate(this,'yyyy-MM-dd')" readonly="true" name="materinf.endTime" value="%{materinf.endTime}"/></td></tr>
				<tr style="margin-top: 5px;"><td style="font-size:12px;color:#636B6D;" align="center">
						物料名称:<s:textfield cssClass="sub3_border" name="materinf.materielName" value="%{materinf.materielName}" cssStyle="margin-top:5px;"/></td></tr>
				<tr style="margin-top: 5px;"><td style="font-size:12px;color:#636B6D;" align="center">
						仓库名称:<s:textfield cssClass="sub3_border" name="materinf.storehouseName" value="%{materinf.storehouseName}" cssStyle="margin-top:5px;"/></td></tr>
				<tr style="margin-top: 5px;"><td style="font-size:12px;color:#636B6D;" align="center">
						供应商名:<s:textfield cssClass="sub3_border" name="materinf.supplierName" value="%{materinf.supplierName}" cssStyle="margin-top:5px;"/></td></tr>
				<tr style="margin-top: 5px;"><td style="font-size:12px;color:#636B6D;" align="center">
						物料类别:<s:select cssClass="sub3_border" list="lsb" listKey="key" listValue="value" name="materinf.materielABC"/></td></tr>
		...
		<div class="center_body">
			...
			<s:hidden cssClass="sub3_border" name="materinf.supplierName" value="%{materinf.supplierName}"/>
				...
				<a href="#" onclick="search1()"><img src="<%=base%>/images/img09.gif" border="0" style="margin-bottom:-4px;" alt="查询" title="查询"></a>
       ...
       <font color="gray">共<s:property value="countValue"/>条记录,合计<s:property value="countSize"/>页</font>
	    <font color="gray">跳转到：<input type="text" onchange="pageChange(this,<s:property value="countSize"/>)" id="size" size="2" name="materinf.startSize" value="<s:property value="startSize"/>" class="pages_border"/>页</font>
	     </s:push> 
	     </s:if>
       </s:form>
		</div>
