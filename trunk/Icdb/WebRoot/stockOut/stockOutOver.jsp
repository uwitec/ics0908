...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<div class="center_body">
			<div class="center_head_text">物料出库</div>
	    ...
	    <s:else>
	       ...
	       <s:iterator value="stockOutList.items" status="stat">
			...
			<td>
			<s:if test="stockOutStateType == 1 && stockOutCheckState==1 && stockOutDealState==1 && stockOutWithState!=1">
				<a href="#"onclick='window.location.href="goStockOutOver.action?stock.stockOutOrderCode=<%=request.getAttribute("stockOutOrderCode")%>"'><img src="<%=base%>/images/img01.gif" border="0"></a>
			</s:if>
			</td>
		</tr>
		</s:iterator>
