...
<html>
	...
	<body>
		<s:form id="searchForm" theme="simple" action="searchCheckStockOut.action"
			namespace="/stockOut">
			<table width="90%" align="center">
				<tr>
					...
					<td id="checkResultTab">
						<s:select id="setStockOutDealStateSelect" name="stock.setStockOutDealState"
							list="#{'0':'未检查','1':'检查通过','-1':'检查未通过'}" value="2"
							value="stock.setStockOutDealState" headerKey="" headerValue="全部"
