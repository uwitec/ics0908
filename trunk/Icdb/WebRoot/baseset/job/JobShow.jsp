	...
	<div class="body_div">
		...
		<div class="center_body">
			...
			<s:form action="ShowJob" namespace="/baseset" theme="simple" >
				<a href="#" onclick="AddJob()" class="a_top"><img src="<%=base%>/images/img06.gif" border="0" alt="添加" title="添加" align="bottom">添加</a>
       ...
       <s:else>
        ...
        <font color="gray">共<s:property value="countValue"/>条记录,合计<s:property value="countSize"/>页</font>
	       <font color="gray">跳转到：<input type="text" onchange="pageChange(this,<s:property value="countSize"/>)" id="size" size="2" name="job.startSize" value="<s:property value="startSize"/>" class="pages_border"/>页</font>
	        </s:push>
	    </s:if> 
       </s:form>
		</div>
