	...
	<div class="body_div">
		...
		<div class="center_body">
			...
			<s:form action="SelectBankDef" namespace="/baseset" theme="simple" >
				<a href="#" onclick="Addbank()" class="a_top"><img src="<%=base%>/images/img06.gif" border="0" align="bottom">添加</a>
	    ...
	    <s:else>
	       ...
	       <s:iterator value="lhp" status="stat">
	        ...
	        <td><s:property value="bankName"></s:property></td>
	       	<td><a href="#" onclick="Updatebank('<s:property value='bankCode'/>')"><img src="<%=base%>/images/img03.gif" border="0" alt="修改"></a>|
	        	<a href="#" onclick="Deletebank('<s:property value='bankCode'/>')"><img src="<%=base%>/images/jinyong.gif" border="0" alt="禁用"></a>
	        </td>
	        </tr>
	       </s:iterator>
	     </table>
