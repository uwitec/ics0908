...
<% String base=request.getContextPath(); %>
	...
	<body class="sub1_body">
		<div class="sub1_title"><img src="<%=base%>/images/img01.gif">添加部门信息</div>
		<div class="sub1_con">
		<s:if test="lsb.size==0">
			请先添加机构信息！
		</s:if>
		<s:else> 
			<s:form action="AddDepartment" namespace="/baseset" theme="simple" name="insertForm">
				<div>部门编号：
					<s:textfield id="decode" name="department.departmentCode" cssClass="sub1_border" readonly="true"/>
					<font id="decode_f" color="red"></font>
				</div>
				<div>部门名称：
					<s:textfield id="dename" name="department.departmentName" cssClass="sub1_border"/>
