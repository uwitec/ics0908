	...
	<div class="body_div">
		...
		<div class="center_body">
			...
			<s:form action="ShowSupplier" namespace="/baseset" theme="simple" >
				<a href="#" onclick="AddSup()" class="a_top"><img src="<%=base%>/images/img06.gif" border="0" class="a_top" alt="添加" title="添加">添加</a>
	    ...
	    <s:else>
	       ...
	       <s:iterator value="lhp" status="stat">
	        ...
	        <td><s:property value="supplierZipCode"></s:property></td>
	       	<td><a href="#" onclick="UpdateSup('<s:property value="supplierCode"/>')"><img src="<%=base%>/images/img03.gif" border="0" title="修改" alt="修改"></a></td>
	       	</tr>
	       </s:iterator>
	     </table>
		<div class="pages">
       ...
       <font color="gray">共<s:property value="countValue"/>条记录,合计<s:property value="countSize"/>页</font>
	       <font color="gray">跳转到：<input type="text" onchange="pageChange(this,<s:property value="countSize"/>)" id="size" size="2" name="supplier.startSize" value="<s:property value="startSize"/>" class="pages_border"/>页</font>
	       </s:push> 
	   </s:if>
       </s:form>
		</div>
