							...
							<tr
								...
								<td>
									...
									<s:if test="stockInStateType == 1 && stockInCheckState==0">
										<a href="#" onclick='window.location.href="goApprovalStockIn.action?stock.stockInCode=<%=request.getAttribute("stockInCode")%>"'><img src="<%=base%>/images/img01.gif" title="审核" alt="审核" border="0"></a>
									</s:if>
							</tr>
						</s:iterator>
					</table>
