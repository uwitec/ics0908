					       ...
					       >
								...
								<td >
									<s:if
										...
										<a href="#" onclick='window.location.href="goEditStockIn.action?stock.stockInCode=<%=request.getAttribute("stockInCode")%>"'><img src="<%=base%>/images/img03.gif" title="编辑" alt="编辑" border="0"></a>|
									</s:if>
									<s:if
										test="stockInStateType == 1 && stockInCheckState==1 && checkResult==1">
										<a href="#"onclick='window.location.href="goStockInOver.action?stock.stockInCode=<%=request.getAttribute("stockInCode")%>"'><img src="<%=base%>/images/img01.gif" title="" alt="" border="0"></a>
									</s:if>
									<s:if
										test="checkResult==-1 || stockInCheckState==-1||(stockInStateType!=1 && stockInStateType!=3)">
										<a href="#" onclick='javasctipt:deleteStockIn(this);'><img src="<%=base%>/images/quit.gif" title="删除" alt="删除" border="0"></a>
									</s:if>
								</td>
							</tr>
						</s:iterator>
