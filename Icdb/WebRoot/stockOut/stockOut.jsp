...
<body topmargin="0">
<s:form id="searchForm" theme="simple" action="searchStockOut.action" namespace="/stockOut">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style='background-color:#E2F3FB;border-left:#0C6A9D 1 solid;border-right:#0C6A9D 1px solid;'>
	...
	<tr style="margin-top: 5px;"><td align="right" style="font-size:12px;color:#636B6D;"></td>
		<td style="font-size:12px;color:#636B6D;">
		&nbsp;&nbsp;&nbsp;&nbsp;开始时间:<s:textfield readonly="true" cssClass="sub3_border" onclick="SelectDate(this,'yyyy-MM-dd')" id="stock.stockOutStartDate" name="stock.stockOutStartDate"  cssStyle="margin-top:5px;"/>
		</td>
	</tr>
	<tr style="margin-top: 5px;"><td align="right" style="font-size:12px;color:#636B6D;"></td>
		<td style="font-size:12px;color:#636B6D;">
		&nbsp;&nbsp;&nbsp;&nbsp;结束时间:<s:textfield readonly="true" cssClass="sub3_border" onclick="SelectDate(this,'yyyy-MM-dd')" id="stock.stockOutEndDate" name="stock.stockOutEndDate" cssStyle="margin-top:5px;"/>
		</td>
	</tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<div class="center_body">
			<div class="center_head_text">出库申请单</div>
	    ...
	    <s:if test="stockOutList.items.size>0">
	    	<tr>
			    <th class="table_head">申请单号</th>
				<th class="table_head">申请时间</th>
				<th class="table_head">审批状态</th>
				<th class="table_head">检查状态</th>
				<th class="table_head">完成状态</th>
				<th class="table_head">是否出库</th>
	    ...
	    <s:else>
	       ...
	       <s:iterator value="stockOutList.items" status="stat">
			...
			<td>
				<s:if test="stockOutDealState==-1||stockOutCheckState==-1||(stockOutStateType!=1 && stockOutStateType!=3 && stockOutCheckState != 1 && stockOutDealState!= 1)">
					<a href="#" onclick='window.location.href="goEditStockOut.action?stock.stockOutOrderCode=<%=request.getAttribute("stockOutOrderCode")%>"'><img src="<%=base%>/images/img03.gif" border="0"></a>
				</s:if>
				<s:if test="stockOutDealState==-1||stockOutCheckState==-1||(stockOutStateType!=1 && stockOutStateType!=3)">
					<a href="#" onclick='javasctipt:deleteStockOut(this);'><img src="<%=base%>/images/quit.gif" border="0"></a>
				</s:if>
			</td>
		</tr>
		</s:iterator>
