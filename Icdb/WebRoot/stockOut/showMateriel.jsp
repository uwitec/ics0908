...
<html>
	<head>
		...
		<script type='text/javascript'>
		 	...
		 	for(var i=0; i<isChecked.length;i++){
		 		if(isChecked[i].checked){
		 			...
		 			var materiel = new Materiel(table.rows.item(i+1).cells.item(1).innerHTML,table.rows.item(i+1).cells.item(2).innerHTML
		 											...
		 											,table.rows.item(i+1).cells.item(5).innerHTML,table.rows.item(i+1).cells.item(6).innerHTML
		 											,table.rows.item(i+1).cells.item(7).innerHTML);
		 ...
		 function Materiel(materielCode,materielName,materielSize,materielABC,cargoSpaceCode, stockPrice, stockAmount){
				...
				<tbody id="materielTbody">
					<s:iterator value="materielList" status="materiel">
						<tr>
							...
							<td bgcolor="white">
								<s:property value="stockPrice"></s:property>
							</td>
							<td bgcolor="white">
								<s:property value="stockAmount"></s:property>
							</td>
						</tr>
					</s:iterator>
				</tbody>
