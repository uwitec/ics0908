...
<html>
	...
	<body>
		<s:form id="searchForm" theme="simple" action="searchStockOutOver.action"
			namespace="/stockOut">
			<table width="90%" align="center">
				<tr>
					...
					<td>
						<s:select id="stockOutStateSelect" name="stock.stockOutWithState"
							list="#{'0':'未出库','1':'已出库'}" value="2"
							value="stock.stockInStateType" headerKey="" headerValue="全部"
							label="单据状态">入库状态</s:select>
					</td>
					<script type="text/javascript">
					//	stockInStateChange();
					</script>
							...
							<tr>
								...
								<td bgcolor="white">
									<s:if
										...
										<input type='button'
											onclick='window.location.href="goStockOutOver.action?stock.stockOutOrderCode=<%=request.getAttribute("stockOutOrderCode")%>"'
											value="出库">
									</s:if>
								</td>
							</tr>
