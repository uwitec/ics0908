	    ...
	    <s:else>
	       ...
	       <s:iterator value="stockOutList.items" status="stat">
			...
			<td>
				...
				<a href="#" onclick='window.location.href="goApprovalStockOut.action?stock.stockOutOrderCode=<%=request.getAttribute("stockOutOrderCode")%>"'><img src="<%=base%>/images/img01.gif" title="审核" alt="审核" border="0"></a>
				</s:if>
			</td>
		</tr>
		</s:iterator>
