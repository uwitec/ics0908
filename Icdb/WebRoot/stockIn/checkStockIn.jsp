		...
		<s:form id="searchForm" theme="simple"
			...
			<div class="body_div">
				<div id="seachDIV" class="searche_DIV"
					...
					<s:select cssClass="sub3_border" id="checkResultSelect"
						name="stock.checkResult"
									...
									<td>
										...
										<s:if
											test="stockInStateType==1 && stockInCheckState==1 && checkResult==0 ">
												<a href="#" onclick='window.location.href="goCheckStockIn.action?stock.stockInCode=<%=request.getAttribute("stockInCode")%>"'><img src="<%=base%>/images/img01.gif" border="0"></a>
										</s:if>
