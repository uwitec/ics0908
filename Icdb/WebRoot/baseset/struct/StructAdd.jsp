...
<% String base=request.getContextPath(); %>
	...
	<body class="sub1_body">
		...
		<div class="sub1_con">
			<s:form action="AddStruct" namespace="/baseset" theme="simple" name="insertForm">
				<div>机构编码：
					<s:textfield id="decode" name="struct.structCode" cssClass="sub1_border" readonly="true"/>
					<font id="decode_f" color="red"></font>
				</div>
				<div>机构名称：
					<s:textfield id="dename" name="struct.structName" cssClass="sub1_border"/>
