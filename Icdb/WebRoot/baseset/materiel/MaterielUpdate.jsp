...
<% String base=request.getContextPath(); %>
	...
	<body class="sub1_body">
		<div class="sub1_title"><img src="<%=base%>/images/img01.gif">修改物料信息</div>
		<div class="sub1_con">
			<s:form action="UpdateMateriel" namespace="/baseset" theme="simple" name="insertForm">
				<div>编码：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div>单价：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<s:textfield name="materiel.materielPrice" onchange="checkprice(this)" cssClass="sub2_border"/>
					<font id="deprice_f" color="red"></font>
				</div>
				<div>最大库存量：
					<s:textfield id="max" name="materiel.materielMaxStore" onchange="isNumcheck(this)" cssClass="sub2_border"/>
					<font id="demax_f" color="red"></font>
				</div>
				<div>最小库存量：
					<s:textfield id="min" name="materiel.materielMinStore" onchange="isNumcheck(this)" cssClass="sub2_border"/>
