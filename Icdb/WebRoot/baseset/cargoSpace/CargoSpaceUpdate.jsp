...
<html>
    ...
    <body>
		...
		<table>
			...
			<s:textfield name="cargoSpaceName" label="仓库名" value="%{cargoSpaceName}"></s:textfield>
			<s:textfield name="cargoSpaceAddress" label="所在地" value="%{cargoSpaceAddress}"></s:textfield>
