...
%>
	...
	<body class="sub1_body">
		...
		<div class="sub1_con">
		   <div align="right">
		    <s:form action="FindBank" namespace="/baseset" theme="simple">
		    <input type="text" name="bank.s_value" class="search_border"/><input type="image" onclick="submit()" src="<%=base%>/images/img09.gif" align="top"/>
		    </s:form>
		  	</div>
		<div>
	    ...
	    <s:else>
	       ...
	       <s:iterator value="lhp" status="stat">
	      	<tr 
	       	...
	       	<td id="bankCode<%=idtitle%>" width="160"><s:property value="bankCode"/></td>
	        <td id="bankName<%=idtitle++%>" width="200"><s:property value="bankName"/></td>
	        </tr>
       		</s:iterator>
		    </table>
       		 <div style="margin-top: 8px;" align="right">  
       		   <s:form action="FindBank" namespace="/baseset" theme="simple" name="pageform">
		       <s:push value="bank">
